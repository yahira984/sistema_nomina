...
<body>
    ...
    <table style="border-collapse: collapse; width: 100%;">
        ...
        <tr>
            <td style="{{ $top }} height: 150px;">
                ...
                @if($pagoDescansoTrabajado > 0)
                    DESCANSO TRAB.&nbsp;<span style="color: #0000FF; font-weight: bold;">{{ $diasDescansoTrabajados }}</span><br>
                @endif
        ...
        <tr>
            <td colspan="2" style="{{ $cell }} height: 62px; font-size: 8px; text-align: justify; vertical-align: top;">
